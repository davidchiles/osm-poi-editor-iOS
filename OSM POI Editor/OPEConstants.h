...
#define kOPEAPIURL3 @"http://www.overpass-api.de/api/xapi?*"
#define kOPEAPIURL2 @"http://overpass.osm.rambler.ru/cgi/xapi?*"
#define kOPEAPIURL4 @"http://api.openstreetmap.fr/xapi?*"
#define kOPEAPIURL1 @"http://api.openstreetmap.org/api/0.6/"
